      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <form action="mailto:kagophuthego0316@gmail.com" method="post" encType="text/plain" className="max-w-xl mx-auto space-y-6 bg-darkCard p-8 rounded-lg shadow-lg">
          <div>
            ...
            <input type="text" id="name" placeholder="Name" className="w-full border border-gray-700 p-3 rounded-md focus:ring-2 focus:ring-accentTeal focus:border-transparent bg-gray-800 text-lightText" required />
          </div>
          <div>
            <label htmlFor="email" className="sr-only">Your Email</label>
            <input type="email" id="email" placeholder="Email address" className="w-full border border-gray-700 p-3 rounded-md focus:ring-2 focus:ring-accentTeal focus:border-transparent bg-gray-800 text-lightText" required />
          </div>
          <div>
            <label htmlFor="message" className="sr-only">Your Message</label>
            <textarea id="message" placeholder="Message" rows={5} className="w-full border border-gray-700 p-3 rounded-md resize-y focus:ring-2 focus:ring-accentTeal focus:border-transparent bg-gray-800 text-lightText" required></textarea>
          </div>
          <button type="submit" className="w-full bg-accentTeal text-darkBg px-6 py-3 rounded-md font-semibold hover:bg-opacity-80 transition duration-300 ease-in-out shadow-md focus:outline-none focus:ring-2 focus:ring-accentTeal focus:ring-opacity-50">
